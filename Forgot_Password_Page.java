...
public class Forgot_Password_Page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel7);
        jLabel7.setBounds(470, 10, 260, 50);
        ...
        jButton3.setBounds(430, 400, 340, 50);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            while(rst.next())
            {
                if(Email.equals(rst.getString(1)) && userid.equals(rst.getString(2)) && password.equals(rst.getString(3)))
                {
                    new Manager_Home_Page();
                }
                else
                {
                    JOptionPane.showMessageDialog(this, "You Enterd Wrong password","DB",JOptionPane.ERROR_MESSAGE);
                }
            }
        }
        catch(Exception e)
